...
BiocManager::install(c( "RSkittleBrewer", "org.Hs.eg.db", "AnnotationDbi"))
...
```{r histograms}
par(mfrow=c(1,2)) #one row and two columns of plots--side by side
...
```{r}
heatmap(ematrix,col=colramp,Rowv=NA,Colv=NA) #remove clustering
```
